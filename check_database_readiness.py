...
def check_schema_file():
    ...
    schema_file = Path("/workspace/database_schema_for_mcp.json")
...
def check_mcp_client_integration():
    ...
    mcp_client_file = Path("/workspace/backend/app/services/mcp_client.py")
...
def check_chart_config_compatibility():
    ...
    try:
        ...
        # 检查是否有图表配置生成器
        config_generator_file = Path("/workspace/backend/app/services/chart_config_generator.py")
