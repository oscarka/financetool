...
from app.utils.logger import (
    log_api, log_database, log_scheduler, log_external,
...
# 外部API调用
log_external("调用基金API", level="INFO", extra_data={"fund_code": "000001", "status": "success"})
...
这套日志管理系统让你可以在Railway上轻松查看、过滤和分析应用日志，再也不用担心日志难以查看的问题了！ 🎉